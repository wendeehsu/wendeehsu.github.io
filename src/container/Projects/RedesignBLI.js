  ...
  return (
    <div>
      ...
      <div className="section">
        <h5>METHOD & TOOL</h5>
        <p>
          Methods: User Research, Wireframe, Mockup, Prototype, Usability
          Testing
          <br />
          Tools: Miro, Figma
        </p>
        ...
        <div className="row justify-content-center">
          <div className="col">
            <img
              ...
              src="/images/BLI/Background1.png"
            />
            <div>
              ...
              <p>
                &#8594; Although the website serves people from all walks, we
                need to select our target audience to narrow down the project
                scope.
              </p>
            </div>
          </div>
          <div className="col">
            <img
              className="restriction-icon"
              src="/images/BLI/Background2.png"
            />
            <div>
              <p className="gray-text">
                Users need to prepare a card reader and Citizen Digital
                Certificate to log in.
              </p>
              <p>
                &#8594; We have to consider more kinds of failure cases to
          ...
          <div className="col">
            <img
              className="restriction-icon"
              src="/images/BLI/Background3.png"
            />
            <div>
              <p className="gray-text">
              ...
              <p>
                &#8594; We need to treat people as first-time users and design
                clear guidance for the website.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="section">
        ...
        <div className="row">
          ...
          <img
            className="full-width-img col-6"
            src="/images/BLI/AffinityDiagram.png"
          />
        </div>
      ...
      <div className="full-width-section">
        ...
        <div className="full-width-inner-section">
          ...
          <p>
            Since the Bureau of Labor Insurance is going to support different
            ways to log in, we enable users to choose a suitable option based on
            the login equipment they have. Besides, the filling fields are
            disabled before the website successfully detected all the required
            login equipment. This will reduce users’ time wasted on filling in
            the fields again and again.
          </p>
        </div>
        <br />
        ...
        <div className="full-width-inner-section gray-bg">
          ...
          <img
            ...
            src="/images/BLI/OldQualification.png"
          />
          <p>
            On the current website, the agreement contains many important
            details like rules about qualification. However, most users will not
            read the content. They may end up finishing the whole application
            process but later found out they were not qualified.
          </p>
        </div>
        <div className="full-width-inner-section">
          <img className="label-img" src="/images/BLI/NewLabel.png" />
          <img
            className="full-width-img"
            src="/images/BLI/NewQualification.png"
          />
          <p>
            As users may not be sure of whether they are qualified to apply for
            a service, we added a qualification check helper before each
            application.
          </p>
        </div>
        <br />
        ...
        <div className="full-width-inner-section">
          ...
          <img
            className="full-width-img"
            src="/images/BLI/NewApplicationProcess.png"
          />
          <p>
      ...
      <div className="section">
        ...
        <div className="row">
          <img
            ...
            src="/images/BLI/Reflection1.png"
          />
          <div className="col">
            ...
            <p>
              As mentioned above, we figured out users prefer the functional
              version of categorizing service during wireframe’s usability
              testing. However, reflecting on this decision, our team think the
              testing scenario may affect users’ preference. Some users were
              heavily aware that they were doing a test, as they told us “I
              finished this question.” instead of “I finished the application
              service.” Not being able to put themselves in the scenario can
              result in behaving differently in comparison with real-life
              scenarios. In the future, besides acknowledging each tool has its
              limitation, we may also add more descriptions to help testers get
              into the scenario.
            </p>
          </div>
        </div>
        <div className="row">
          <img
            className="reflection-icon col"
            src="/images/BLI/Reflection2.png"
          />
          <div className="col">
            <p className="bold-text">
            ...
            <p>
              To be frank, no matter how unfriendly the user experience is,
              people have no other choice but to keep using governmental
              websites. Hence, integrating users’ thoughts or demands in the
              website’s designing phase will not be considered crucial.
              Therefore, it will be better to elaborate on why we made these
              design changes and how these modifications can reduce the stress
              of the staff at the counter when cooperating with public sectors
              next time. Otherwise, the suggestions may not be seriously taken
              into discussion.
            </p>
          </div>
        </div>
        <div className="row">
          <img
            className="reflection-icon col"
            src="/images/BLI/Reflection3.png"
          />
          <div className="col">
            <p className="bold-text">
              3. We should consider regulations and limitations to enhance the
              viability
            </p>
            <p>
              In this project, we redesigned the information architecture,
              categorizing services based on their function after wireframe
              testing. However, we later realized that although this structure
              is preferred by most users, the guideline for public sector's
              websites writes that it is required to categorize services based
              on people's stage of life (Giving birth, working, retired, etc.)
              If we have more time, we will try to cooperate with the Bureau’s
              staff closer in the early stage to know about regulations and
              limitations, enhancing the viability of our final design.
            </p>
          </div>
        </div>
      </div>

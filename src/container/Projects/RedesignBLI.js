    ...
    <div>
      ...
      <div className="section">
        ...
        <ul>
          ...
          <li>
            <a
              href="https://medium.com/@as964119/about"
              target="_blank"
              rel="noreferrer">
              Nuan-Ting Lin
            </a>{" "}
      ...
      <div className="full-width-inner-section gray-bg">
        ...
        <img src={`${imageBaseUrl}OldLogin.png`} alt="Old Login" />
        <p>
      ...
      <div className="full-width-inner-section">
        ...
        <img src={`${imageBaseUrl}NewLogin.png`} alt="New Login" />
        <p>
      ...
      <div className="full-width-inner-section gray-bg">
        <Label text="Old" textColor="text-white" bgColor="bg-gray-400" />
        <img src={`${imageBaseUrl}OldInquiry.png`} alt="old inquiry" />
        <p>
      ...
      <div className="full-width-inner-section">
        <Label text="New" textColor="" bgColor="bg-sky-100" />
        <img src={`${imageBaseUrl}NewInquiry.png`} alt="new inquiry" />
        <p>
